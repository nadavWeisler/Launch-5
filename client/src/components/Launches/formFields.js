export default [
    ...
    { label: 'נמען דואר אלקטרוני', name: "emailSender", type: 'text'},
    { label: 'נמען נוסף (CC) דואר אלקטרוני', name: "emailCc", type: 'text'},
    { label: 'נמען נסתר (BCC) דואר אלקטרוני', name: "emailBcc", type: 'text'},
